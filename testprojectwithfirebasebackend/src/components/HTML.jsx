...
const HTML = (props) => {
  ...
  useEffect(() => {
    const fetchQuestion = async () => {
      ...
      const htmlQuestionPaper = firestore.collection("htmlQuestionPaper");
      const snapShot = await htmlQuestionPaper.get();
      ...
      setHtmlData(sortedQuestionsData);
    };
    ...
    console.log(submitData)
        ...
        // console.log(studentName)
          // Save students's exam data
            firestore.collection('student_exam_html').doc(studentName).set(submitData)
            .then(() => {
